...
function [eta,inner_it,stop_tCG,timeinfo] = tCG_LSR1(fns,x,grad,S,Y,SS,SY,start_index,gamma,eta,Delta,times,params,timeinfo)
% tCG - Truncated (Steihaug-Toint) Conjugate-Gradient
   ...
   for j = 1:max_inner,
    ...
    Hxd = Hv_LSR1(fns, x, S, Y, SS, SY, delta, gamma, start_index);
