    ...
    for rdim = [4,5]  % to be [4,5,6,7]
        ...
        for tolKKTres = tolKKTrespowerset
            for rankval = minrank:maxrank
                for eqconstratio = [0.5] % to be [0,0.3,0.5,0.7,1]
                    for maskratio = [0.5] % [0.1,0.3,0.5]
                        ...
                        % SKIPPED because PA will be
                        % constructed in clients according to equality
                        % constraints (elements used as eq. consts. are eliminated from P)
...
%         for tolKKTres = tolKKTrespowerset
%             for rankval = minrank:maxrank
%                 for eqconstratio = [0.5] % to be [0.5]
%                     for maskratio = [0.3] % [0.3]
%                         %_______Set up data______
% 
%                         %______Set Object matrix_____
%                         % Generate a random mxn matrix A of rank k
